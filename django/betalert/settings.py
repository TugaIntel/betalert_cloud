...
# Ensure pymysql is used as MySQL database driver
...
ALLOWED_HOSTS = [
    '*.innate-empire-422116-u4.ew.r.appspot.com',  # Subdomains
    'innate-empire-422116-u4.ew.r.appspot.com',    # Main GAE domain
    'mybotandai.com',                              # Your custom domain
...
DATABASES = {
    'default': {
        ...
        'HOST': '/cloudsql/{}'.format(INSTANCE_CONNECTION_NAME),
        'OPTIONS': {
