...
SET ENV_VARS=INSTANCE_CONNECTION_NAME=innate-empire-422116-u4:europe-west1:betalert,DB_USER=betadmin,DB_PASS=Welcome!123,DB_NAME=BetAlert,PRIVATE_IP=false
