...
SET SOURCE_PATH=D:\TugaIntel\BetAlert_Cloud\functions
    SET ENV_VARS=INSTANCE_CONNECTION_NAME=innate-empire-422116-u4:europe-west1:betalert-db-db,DB_USER=betadmin,PROJECT_ID=innate-empire-422116-u4,DB_NAME=BetAlert,PRIVATE_IP=false
